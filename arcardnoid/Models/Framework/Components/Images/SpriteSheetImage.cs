...
namespace arcardnoid.Models.Framework.Components.Images
{
    public class SpriteSheetImage : Image
    {
        ...
        {
            Game.SpriteBatch.Draw(Sprite, ScreenManager.Scale(DrawBounds.ToRectangle()), _rects.ElementAt(_index), Color, MathHelper.ToRadians(Rotation), Origin, SpriteEffects.None, 0);
        }
