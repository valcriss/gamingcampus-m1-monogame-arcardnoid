...
{
    public class HeartUI : Component
    {
        ...
        public HeartUI(int x, int y) : base("HeartUI", x, y, 58, 50)
        {
        ...
        {
            base.Draw();
            Game.SpriteBatch.Draw(heartTexture, ScreenManager.Scale(Bounds.ToRectangle()), _imageBounds, Color, MathHelper.ToRadians(Rotation), Vector2.Zero, SpriteEffects.None, 0);
        }
